...
use App\Containers\AppSection\Authentication\Exceptions\UserLockedException;
...
class ProxyLoginForWebClientAction extends Action
{
    public function run(ProxyLoginPasswordGrantRequest $request): array
    {
        ...
        $this->processEmailConfirmationAndActiveStatusIfNeeded($responseContent);
    ...
    private function processEmailConfirmationAndActiveStatusIfNeeded($response): void
    {
