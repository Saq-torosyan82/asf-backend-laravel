...
return [
    ...
    */
    ...
    /*
     * number of minutes for login token lifetime
     */

    'login_token_expiration' => 60,

    /*
     * number of minutes for magic link token lifetime
     */

    'login_magic_link_token_expiration' => 10,

    /*
     * number of minutes for login lender token lifetime
     */

    'login_lender_token_expiration' => 60 * 24 * 7,

    /*
     * number of characters for login token
     */
    'login_token_size' => 60,
     ...
     * link for auto-login
     */
    'login_token_redirect' => env('MAIN_URL') . '/auto-login',
];
