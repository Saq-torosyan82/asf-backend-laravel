 ...
 * @apiName            GetDeals
 *
 * @api                {GET} /v1/deals Get deals
 * @apiDescription     Get deals by user id , if the user is admin all deals will be returned
 *
 * @apiVersion         1.0.0
...
Route::get('deals', [Controller::class, 'GetDeals'])
    ->name('api_deal_get_deals')
    ->middleware(['auth:api']);
