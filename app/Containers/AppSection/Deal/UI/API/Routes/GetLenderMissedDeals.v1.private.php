...
/**
 * @apiGroup           Deal
 * @apiName            getLendersMissedDeals
 *
 * @api                {GET} /v1/ Get Lender missed deals
 * @apiDescription     Get Lender missed deals
 *
 * @apiVersion         1.0.0
...
Route::get('deals-missed', [Controller::class, 'getLendersMissedDeals'])
    ->name('api_deal_get_lenders_missed_deals')
    ->middleware(['auth:api']);
