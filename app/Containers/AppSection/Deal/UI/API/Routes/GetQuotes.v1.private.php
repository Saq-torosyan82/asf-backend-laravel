 ...
 * @apiName            getQuotes
 *
 * @api                {GET} /v1/ Get quotes
 * @apiDescription    Get quotes, The period is set in config "appSection-deal.last_quotes_period"
 *
 * @apiVersion         1.0.0
...
Route::get('quotes', [Controller::class, 'getQuotes'])
    ->name('api_deal_get_quotes')
    ->middleware(['auth:api']);
