 ...
 *
 * @api                {GET} /v1/users/:id/documents Get user documents
 * @apiDescription     Get user documents
 *
 * @apiVersion         1.0.0
...
Route::get('users/{user_id}/documents', [Controller::class, 'GetUserDocuments'])
    ->name('api_upload_get_user_documents')
    ->middleware(['auth:api']);
