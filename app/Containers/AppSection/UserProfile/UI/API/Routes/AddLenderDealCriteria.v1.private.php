 ...
 * @apiName            AddLenderDealCriteria
 *
 * @api                {POST} /v1/me/lender-criteria Add lender criteria
 * @apiDescription     Add lender criteria
 *
 * @apiVersion         1.0.0
...
Route::post('me/lender-criteria', [Controller::class, 'AddLenderDealCriteria'])
    ->name('api_userprofile_add_lender_deal_criteria')
    ->middleware(['auth:api']);
