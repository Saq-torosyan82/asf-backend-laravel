 ...
 *
 * @api                {PATCH} /v1/users/{id}/profile Update user profile
...
Route::patch('users/{id}/profile', [Controller::class, 'UpdateUserProfile'])
    ->name('api_userprofile_update_user_profile')
    ->middleware(['auth:api']);
